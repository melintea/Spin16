...
static const char *Code2a[] = { /* the tail of procedure run() */
	...
	"",
	"void",
	"store_state(Trail *ntrpt, int shortcut, int oboq)",
	"{",
	"	#ifdef VERI",
	"	Trans *t2 = (Trans *) 0;",
	"	" TOSTR(SPIN_QID_T) " ot; int tt, E_state;",
	...
	"	int tt, E_state;",
	"	int II, From = (int) (now._nr_pr-1), To = BASE;",
	"	int oboq = boq;",
	"",
...
static const char *Code2d[] = {
	...
	"#ifdef INLINE_REV",
	"uchar",
	"do_reverse(Trans *t, int II, uchar M)",
	"{	uchar _m = M;",
	...
	"	#ifdef EVENT_TRACE",
	"	int oboq = boq;",
	"	TOSTR(SPIN_QID_T) ot = (" TOSTR(SPIN_QID_T) ")  ((P0 *)_this)->_t;",
	...
	"	int res = 0; int tt; " TOSTR(SPIN_QID_T) " ot;",
	"",
	"	pid += BASE;",
	"	if (pid == iam)",
	...
	"	||  i >= (int) now._nr_pr",
	"#ifdef HAS_PROVIDED",
	"	|| !provided(i, (" TOSTR(SPIN_QID_T) ") ((P0 *)_this)->_t, (int) ((P0 *)_this)->_p, t)",
	"#endif",
	"	)",
	"	{	return 0;",
	"	}",
	...
	"#ifdef HAS_PROVIDED",
	"		&&  provided(i, (" TOSTR(SPIN_QID_T) ") ((P0 *)_this)->_t, (int) ((P0 *)_this)->_p, 0)",
	"#endif",
...
"#endif",
	...
	"int",
	"Unwind(void)",
	"{	Trans *t; " TOSTR(SPIN_QID_T) " ot, _m; int tt; int II;",
	"#ifdef VERBOSE",
	"	int i;",
	"#endif",
	"	uchar oat = now._a_t;",
