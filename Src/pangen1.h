...
static const char *Code2d[] = {
	...
	"	||  i >= (int) now._nr_pr",
	"#ifdef HAS_PROVIDED",
	"	|| !provided(i, (ushort) ((P0 *)_this)->_t, (int) ((P0 *)_this)->_p, t)",
	"#endif",
	"	)",
	"	{	return 0;",
	"	}",
	...
	"#ifdef HAS_PROVIDED",
	"		&&  provided(i, (ushort) ((P0 *)_this)->_t, (int) ((P0 *)_this)->_p, 0)",
	"#endif",
...
"#endif",
	...
	"int",
	"Unwind(void)",
	"{	Trans *t; ushort ot, _m; int tt; int II;",
	"#ifdef VERBOSE",
	"	int i;",
	"#endif",
	"	uchar oat = now._a_t;",
