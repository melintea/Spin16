...
static const char *Code2c[] = { /* multi-core option - Spin 5.0 and later */
	...
	"#define QUIT		MAX_SPIN_MSGID+200	/* terminate now command */",
	"#define QUERY		MAX_SPIN_MSGID+100	/* termination status query message */",
	"#define QUERY_F	MAX_SPIN_MSGID+101	/* query failed, cannot quit */",
	"",
	...
	"	volatile int	m_boq;		/* rendezvous/channel index; values >= QUERY are control */",
	"#ifdef FULL_TRAIL",
...
"#endif", /* WIN32 || WIN64 */
	...
	"	SPIN_PID_T  pr;	/* process that made transition */",
	...
	"",
	"void",
	"Push_Stack_Tree(int II, T_ID t_id)",
	"{	volatile Stack_Tree *st;",
	"",
...
"#endif", /* !SEP_STATE */
	...
	"		}",
	"",
	"		/* else: normal STATE transfer (boq < QUERY) */",
