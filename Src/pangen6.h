...
static const char *Code2c[] = { /* multi-core option - Spin 5.0 and later */
	...
	"#define QUIT		MAX_SPIN_MSGID+200	/* was 1024; terminate now command */",
	"#define QUERY		MAX_SPIN_MSGID+100	/* was 512; termination status query message */",
	"#define QUERY_F	MAX_SPIN_MSGID+101	/* was 513; query failed, cannot quit */",
	"",
...
"#endif", /* WIN32 || WIN64 */
	...
	"	ushort      pr;	/* process that made transition */",
