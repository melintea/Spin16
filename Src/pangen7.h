...
static const char *pan_par[] = {	/* generates pan.p */
	...
	"extern void	bfs_store_state(Trail *, int);",
	...
	"#endif",
	"	int tt;",
	"	int II, To = BASE, From = (int) (now._nr_pr-1);",
	"	int oboq = boq;",
	"	uchar _n, _m, ot;",
	"",
	...
	"#endif",
	"#if SYNC>0",
	"	bfs_ewrite(bfs_out_fd[who_are_you], (const void *) &(n->s_data->boq), sizeof(int));",
	"#endif",
	"#if VERBOSE",
	...
	"#endif",
	"#if SYNC>0",
	"	bfs_eread(fd, (void *) &(n->s_data->boq), sizeof(int));",
	"#endif",
	"#if VERBOSE",
	...
	"",
	"void",
	"bfs_store_state(Trail *t, int oboq)",
	"{",
	"#ifdef TRIX",
	"	sv_populate();",
	"#endif",
