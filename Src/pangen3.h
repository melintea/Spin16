...
static const char *Head0[] = {
	...
	"	int   qu[6];	/* for conditional selections: qid's  */",
...
/*	"	#define Pptr(x)	((proc_offset[x])?pptr(x):noptr)",	*/
	...
	"",
	"#define MAXQ   	" TOSTR(MAX_SPIN_QID),
	"#define MAXPROC	" TOSTR(MAX_SPIN_PID),
	"#ifdef TRIX",
	"	#ifdef VECTORSZ",
...
static const char *Head1[] = {
	...
	"	ushort  _last;	/* pid executed in last step */",
	"#endif",
